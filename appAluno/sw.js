const CACHE_NAME = "flowfit-aluno-v52";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./js/data/repositories/workout-repository.js?v=build-20260811-1",
  "./js/data/repositories/session-repository.js?v=build-20260811-1",
  ...
  "./js/core/store.js?v=build-20260811-1",
  "./js/core/session-draft-storage.js?v=build-20260811-1",
