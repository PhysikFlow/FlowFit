const CACHE_NAME = "flowfit-aluno-v51";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./css/app.css?v=build-20260810-9",
  "./js/app.js?v=build-20260810-11",
  ...
  "./js/data/repositories/workout-repository.js?v=build-20260810-8",
  "./js/data/repositories/session-repository.js?v=build-20260810-8",
  ...
  "./js/core/store.js?v=build-20260810-7",
