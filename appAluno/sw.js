...
const APP_SHELL = [
  ...
  "./js/screens/profile/student-profile-editor.js?v=build-20260822-1",
  "./js/screens/notifications/notifications-screen.js?v=build-20260816-1",
  "./js/state/app-state.js?v=build-20260822-1",
  "./js/state/workout-session-state.js?v=build-20260823-2",
  "./js/utils/formatters.js?v=build-20260816-1",
  "./js/data/repositories/auth-repository.js?v=build-20260812-6",
  "./js/data/repositories/student-repository.js?v=build-20260825-1",
  ...
  "./js/data/repositories/workout-repository.js?v=build-20260825-1",
  "./js/data/training-domain.js?v=build-20260823-2",
  "./js/data/repositories/programming-repository.js?v=build-20260825-2",
  "./js/data/causal-sync.js?v=build-20260825-1",
  "./js/data/program-application.js?v=build-20260825-1",
  "./js/data/program-schedule.js?v=build-20260825-1",
  "./js/interaction/runner-swipe.js?v=build-20260825-1",
