...
const APP_SHELL = [
  ...
  "../appAluno/js/core/brand-theme.js?v=build-20260813-1",
  ...
  "../appAluno/js/data/repositories/student-repository.js?v=build-20260813-1",
  "../appAluno/js/data/repositories/theme-repository.js?v=build-20260813-1",
