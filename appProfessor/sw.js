const CACHE_NAME = "flowfit-professor-v27";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./css/app.css?v=build-20260811-1",
  "./js/app.js?v=build-20260811-1",
  ...
  "../appAluno/js/data/repositories/workout-repository.js?v=build-20260811-1",
  "../appAluno/js/data/repositories/session-repository.js?v=build-20260811-1"
];
